...
router.post('/admin/new', upload.single("adminPerfil"), (req, res) => {
...
router.post('/admin/edit',upload.single("adminPerfil"), (req, res) => {
...
router.post('/admin/edit/response', (req, res) => {
...
router.post('/admin/delete/cliente', (req, res) => {
    var {idCliente} = req.body;
    usuario.ExluiCliente(Cliente, res, idCliente, "/admin/clientes");
});

router.get('/admin/suporte/cliente', (req, res) => {
...
router.post('/admin/suporte/cliente', (req, res) => {
